...
class DailyDetailedWeatherView extends StatelessWidget {
  ...
  final int index;
  const DailyDetailedWeatherView({super.key, required this.dailyDetailedLocationForecastData, required this.resortName, required this.index});
    ...
    return Card (
      child: Column(
        ...
        children: [
          ...
          Text('Minimum: ${dailyDetailedLocationForecastData['temp']['min'].toString()}\u{00B0}'),
          Text('Maximum: ${dailyDetailedLocationForecastData['temp']['max'].toString()}\u{00B0}'),
          Text('Morning: ${dailyDetailedLocationForecastData['temp']['morn'].toString()}\u{00B0}'),
          Text('Day:     ${dailyDetailedLocationForecastData['temp']['day'].toString()}\u{00B0}'),
          Text('Evening: ${dailyDetailedLocationForecastData['temp']['eve'].toString()}\u{00B0}'),
          Text('Night:   ${dailyDetailedLocationForecastData['temp']['night'].toString()}\u{00B0}'),
        ],
      ),
    );
  }
